...
print (f"Application started! on {SERIAL_PORT}")
# {'baudrate': '9600', 'bytesize': 8, 'parity': 'N', 'port': '/dev/serial0', 'stopbits': 1, 'timeout': 1}
gps = serial.Serial(SERIAL_PORT, baudrate = 9600, bytesize=8, parity='N', stopbits=1, timeout = 1)
